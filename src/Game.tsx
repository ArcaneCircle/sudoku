...
export const Game: React.FC<{}> = () => {
  ...
  function onClickCell(indexOfArray: number) {
    ...
    if (!fastMode) setCellSelected(indexOfArray);
  }
  ...
  function onClickFastMode() {
    if (fastMode) setNumberSelected("0");
  ...
  useEffect(() => {
    ...
    if (state) {
      ...
      _continueGame(
        parsedState.initArray,
        parsedState.currentArray,
        parsedState.solvedArray,
        parsedState.historyArray,
      );
    } else {
      _createNewGame();
    }
      ...
      >
        <h2 className="overlay__text">
          {won ? (
            ...
            <>
              S<span className="overlay__textspan1">c</span>
              <span className="overlay__textspan2">o</span>r
              <span className="overlay__textspan1">e</span>
              <span className="overlay__textspan2">b</span>o
              <span className="overlay__textspan1">a</span>
              <span className="overlay__textspan2">r</span>d
            </>
          )}
        </h2>
